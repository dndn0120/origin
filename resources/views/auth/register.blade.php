                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select id="division" name="division">
                                    ...
                                    <option value="0001">솔루션사업부</option>
                                    <option value="0002">디자인사업부</option>
                                    <option value="0003">도메인사업부</option>
                                    <option value="0004">경영기획사업부</option>
                                </select>
                            </div>
                        </div>
